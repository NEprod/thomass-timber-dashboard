...
def calc_square_full(section, wall_width, wall_height, horz_squares, vert_squares, slat_width, board_length, kerf):
    ...
    section.vars['square_width_var'] = (str(square_width))
    section.vars['square_height_var'] = (str(square_height))
    section.vars['horz_pieces_per_strip_var'] = (str(horz_pieces_per))
    section.vars['vert_strips_var'] = (str(len(section.square_strip_cut_list['vertical'])))
    section.vars['horz_strips_var'] = (str(len(section.square_strip_cut_list['horizontal'])))