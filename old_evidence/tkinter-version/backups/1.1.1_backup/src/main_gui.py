...
from square_panelling_measurments import SquarePanellingWindow
...
class TimberPricingApp:
    ...
    def open_square_panelling_measurements(self):
        SquarePanellingWindow(self.root)
    ...
    def build_interface(self):
        ...
        tk.Button(job_measurments_frame, text="Square Panelling", command=self.open_square_panelling_measurements, width=20).pack(padx=0, pady=0)
