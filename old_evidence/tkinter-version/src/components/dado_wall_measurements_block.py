...
from components.dado_wall_section_input_block import DadoWallSectionInputBlock
from components.dado_wall_stair_section_input_block import DadoWallStairSectionInputBlock

class DadoWallMeasurementsBlock:
    def __init__(self, parent, on_change=None):
        self.panel_type_var = None
        self.on_change = on_change
        self.frame = ttk.LabelFrame(parent, text="Dado Wall Measurements")
    ...
    def add_wall_section(self):
        ...
        section_block = DadoWallSectionInputBlock(self.section_container, index=index, on_change=self.on_change)
    ...
    def add_stair_section(self):
        ...
        section_block = DadoWallStairSectionInputBlock(self.section_container, index=index, on_change=self.on_change)
